...
export interface NodeInput<
    I,
    O,
    T extends _NodeComponent<O, any, any> = _NodeComponent<O, unknown>
> { 
...
export type TargetOf<N> = 
    N extends _NodeComponent<any, any, infer T> 
        ? T
        : unknown
 ...
 */
export abstract class _NodeComponent<
    I = unknown,
    O = I,
    T extends _NodeComponent<O, any, any> = any
